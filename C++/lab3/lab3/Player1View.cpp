...
namespace Game {
	...
	Player1View::Player1View(sf::RenderWindow& window) : _window(window) { 
		sf::Image bg;
	...
	void Player1View::set_ships_on_field() {
		reset_view();
	...
	void Player1View::set_kill_on_field(int pos_x, int pos_y) {
	...
	void Player1View::set_miss_on_field(int pos_x, int pos_y) {
		sf::Sprite* s = new sf::Sprite;
		s->setPosition(pos_x, pos_y);
	...
	void Player1View::set_hit_on_field(int pos_x, int pos_y) {
		sf::Sprite* s = new sf::Sprite;
		s->setPosition(pos_x, pos_y);
	...
	void Player1View::set_back_ground(const char* bg_path) {
		sf::Image bg;
	...
	std::vector<Button*> Player1View::get_buttons() const {
		return _buttons;
	}

	std::vector<Ship*> Player1View::get_ships() const {
		return _ships;
	}

	void Player1View::reset_view() {
	...
	Game::Player1Model& Player1View::get_model() {
		return _model;
	}
